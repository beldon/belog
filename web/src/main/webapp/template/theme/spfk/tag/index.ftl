...
<section class="archives-wrap">
    ...
    <div class="archives">
        ...
        <nav id="page-nav">
            <#if articlePage.pageNo !=1>
                <a class="extend prev" rel="prev" href="${BASE_PATH}/tag/${key!}/${frontPage}.html">« Prev</a>
            </#if>
            <#list 1 .. articlePage.totalPage as page>
                <#if page == articlePage.pageNo>
                    <span class="page-number current">${page}</span>
                <#else>
                    <a class="page-number" href="${BASE_PATH}/tag/${key!}/${page}.html">${page}</a>
                </#if>
            </#list>
            <#if articlePage.pageNo !=articlePage.totalPage>
                <a class="extend next" rel="next" href="${BASE_PATH}/tag/${key!}/${nextPage}.html">Next &raquo;</a>
            </#if>
        </nav>
    </div>
</section>
