require([], function (){
    ...
    var loadMobile = function(){
        var mobilejs = $("#themePath").val() + "/js/mobile.js";
        //require(['/js/mobile.js'], function(mobile){
        require([mobilejs], function(mobile){
            mobile.init();
            isMobileInit = true;
        });
    }
    var isPCInit = false;
    var loadPC = function(){
        var psjs = $("#themePath").val() + "/js/pc.js";
        //require(['/js/pc.js'], function(pc){
        require([psjs], function(pc){
            pc.init();
            isPCInit = true;
        });
    }
    ...
    if(yiliaConfig.fancybox === true){
        var fancybox = $("#themePath").val() + "/fancybox/jquery.fancybox.js";
        //require(['/fancybox/jquery.fancybox.js'], function(pc){
        require([fancybox], function(pc){
            var isFancy = $(".isFancy");
            if(isFancy.length != 0){
    ...
    if(yiliaConfig.animate === true){
        var lazyloadjs = $("#themePath").val() + "/js/jquery.lazyload.js";
        //require(['/js/jquery.lazyload.js'], function(){
        require([lazyloadjs], function(){
            //avatar
